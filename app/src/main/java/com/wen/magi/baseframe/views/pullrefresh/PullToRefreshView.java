...
//        downBitmap = BitMapUtils.scaleImg(downBitmap, (int) (downBitmap.getWidth() * rote), (int) (downBitmap.getHeight() * rote));
//        upBitmap = Handler_Bitmap.scaleImg(upBitmap, (int) (upBitmap.getWidth() * rote), (int) (upBitmap.getHeight() * rote));
        ...
        LayoutParams layoutParams = new LayoutParams(LayoutParams.FILL_PARENT, (int) (100));
        layoutParams.bottomMargin = (int) (15);
        layoutParams.topMargin = (int) (15);
        ...
        RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams((int) (40), (int) (40));
        rl.leftMargin = (int) (30);
        rl.rightMargin = (int) (20);
        ...
        vto.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            public boolean onPreDraw() {
                ...
                if (mAdapterView != null) {
                    ...
                    if (LayoutParams.class.isAssignableFrom(mAdapterView.getLayoutParams().getClass())) {
                        // 重置listview的高度
                    ...
                    if (LayoutParams.class.isAssignableFrom(PullToRefreshView.this.getLayoutParams().getClass())) {
                        // 重置下拉组件的高度
                        LayoutParams params = (LayoutParams) PullToRefreshView.this.getLayoutParams();
                        if (heigth != 0) {
