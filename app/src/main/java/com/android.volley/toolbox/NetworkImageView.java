...
import com.wen.magi.baseframe.managers.AppSettingsManager;
...
//    public void tryLoadFromCacheFile() {
//        try {
//            if (LangUtils.isEmpty(mUrl))
//                return;
//            String fileName = mUrl.replace("/", "_").replace(":", "_")/*.substring(30) + ".jpg"*/;
//            if (fileName.length() > 100) {
//                fileName = fileName.substring(0, 100);
//            }
//            File fileRootPath = Environment.getExternalStorageDirectory()/*CacheManager.getManager().getCacheDir()*/;
...
//
////        LogUtils.d(">>>> tryLoadFromCacheFile picFile=%s; picFile.isFile=%s", picFile.getAbsolutePath(), picFile.isFile());
//            if (picFile.exists()) {
//                Bitmap bitmap = BitmapFactory.decodeFile(picFile.getAbsolutePath());
////          LogUtils.d(">>>> tryLoadFromCacheFile bitmap=%s", bitmap);
//                if (bitmap != null) {
//                    setImageBitmap(bitmap);
////            LogUtils.d(">>>> tryLoadFromCacheFile setImageBitmap(bitmap)=%s", bitmap);
//                }
//            } else {
...
//    public void saveToCacheFile(Bitmap bitmap) {
//        try {
//            if (doTryLoadingFromCacheFile()) {
//
//                String fileName = mUrl.replace("/", "_").replace(":", "_")/*.substring(30) + ".jpg"*/;
//                if (fileName.length() > 100) {
//                    fileName = fileName.substring(0, 100);
...
//                    tmpRoot.mkdir();
//                }
//                if (new File(tmpRoot, fileName).exists()) {
//                    LogUtils.d("#### saveToCacheFile hasExisted!");
//                    return;
//                }
//                LogUtils.d("#### saveToCacheFile filePath=%s", new File(tmpRoot, fileName).getAbsolutePath());
//                IOUtils.saveBitmap(bitmap, new File(tmpRoot, fileName), Bitmap.CompressFormat.JPEG, 85);
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//                            saveToCacheFile(response.getBitmap());
